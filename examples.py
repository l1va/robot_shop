...
def example_world():
    ...
    world.include_model("manipulators/iiwa14")
    world.include_model("manipulators/iiwa14", pose=[1, 1, 0, 0, 0, 0])
    world.include_model("manipulators/iiwa14", pose=[2, 0, 0, 0, 0, 0])
